...
@interface TakePhotoThirdController ()
...
@implementation TakePhotoThirdController
...
-(void)loadingChildView{
    ...
    [imageView setImage:[UIImage imageNamed:@"take_photo_example_3"]];
...
-(void)sumbitPhoto{
    ...
    [dataDic setObject:@"3" forKey:@"index"];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (error==nil) {
                ...
                NSString *index = [NSString stringWithFormat:@"%@",[model.Data objectForKey:@"index"]];
